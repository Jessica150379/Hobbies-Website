...
let save = [];
let salsaLink = document.getElementById('salsaLink').href;
let salsaSaveLinkBtn = document.getElementById('salsaSaveBtn');
let salsaVid = document.getElementById('salsaVid').src;
let salsaSaveVidBtn = document.getElementById('salsaVidBtn');
...
salsaSaveLinkBtn.addEventListener('click',saveForLater.bind(this,salsaLink));
salsaSaveVidBtn.addEventListener('click',saveForLater.bind(this,salsaVid));
